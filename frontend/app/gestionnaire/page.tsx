                  ...
                  {donneesRepartition.map((d) => (
                    <div key={d.nom} className="flex items-center justify-between text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-text-secondary">{d.nom}</span>
                      </div>
                      <span className="font-medium text-text-primary">{d.valeur}</span>
                    </div>
                  ))}
                </div>
              </>
          ...
          <CardBody className="space-y-5">
            <div>
              <div className="mb-1.5 flex items-center justify-between text-sm">
                <span className="text-text-secondary">Taux d'acceptation</span>
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between text-sm">
                <span className="text-text-secondary">Taux de refus</span>
                <span className="font-semibold text-text-primary">{tauxRefus}%</span>
              </div>
            ...
            <div className="flex items-center gap-2 rounded-lg bg-muted px-3 py-2.5">
              ...
              <span className="text-sm text-text-secondary">
                <span className="font-semibold text-text-primary">{stats.en_cours}</span>{" "}
