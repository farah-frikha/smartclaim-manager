          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              return (
                ...
                >
                  <Icon className={`h-5 w-5 ${actif ? "text-teal-600" : "text-slate-400"}`} />
                  <span className={`text-sm font-medium ${actif ? "text-teal-700" : "text-slate-600"}`}>
                    {t.label}
                  </span>
        ...
        <CardBody className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm outline-none transition-colors focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20"
              placeholder="••••••••"
            />
          </div>
